原文：https://compilation-course.github.io/introduction/lab1.html
...
The second command transforms the Tiger source into an *object file* which contains
the generated assembly code.

The third command links the *object file* with the runtime library which contains
...
We will familiarize ourselves with the Tiger language by writing a few programs. If in doubt check the [specifications of the Tiger language](https://web.archive.org/web/20221225030918/https://www.lrde.epita.fr/~akim/ccmp/tiger.pdf)
...
![Automaton to determinise](https://compilation-course.github.io/introduction/determ2.png)