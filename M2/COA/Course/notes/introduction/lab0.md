原文：https://compilation-course.github.io/introduction/lab0.html
...
by the lecture *Gerez vos codes souces avec git* from M. Nebra.
...
participating in the same project has its own *git* repository. Developers
can exchange versions and commits (changes) in a peer-to-peer fashion.
Often a central *repository* is created on a server. The central repository
