原文：https://compilation-course.github.io/lexical-and-syntax-analysis/7-slr.html
...
Consider \(G\_3\), with \(V=\{S, E\}\) and \(\Sigma=\{id,\#\}\), with rules

1. \[S \rightarrow E\#\]
2. \[E \rightarrow id\ E\]
3. \[E \rightarrow id\]

This grammar can parse words like \(id\ id\#\) which belong to \(L(G\_3)\).
